...
class _RelatedArticlesState extends State<RelatedArticles> {
  ...
  void didChangeDependencies() {
    ...
    data = TenwanService().fetchPostsByCategoryIdExceptPostId(widget.postId, widget.catId, 10);
  }
                ...
                default:
                  ...
                  return ListView.separated(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        return Card5(
                          article: article!, scaffoldKey: widget.scaffoldKey, heroTag: 'recent${article.id}',);
                      });
              }
            },
          ),
